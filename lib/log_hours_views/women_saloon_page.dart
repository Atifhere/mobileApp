...
import 'package:hair_saloon/controllers/women_saloon_page_controller.dart';
import 'package:loading_animation_widget/loading_animation_widget.dart';

import '../controllers/men_saloon_page_controller.dart';
import '../halper/app_colors.dart';
import '../halper/methods.dart';
import '../services/api_services.dart';


class WomenSaloonPage extends StatefulWidget {
  const WomenSaloonPage({super.key});

  @override
  State<WomenSaloonPage> createState() => _WomenSaloonPageState();
}

class _WomenSaloonPageState extends State<WomenSaloonPage> {
  final WomenSaloonPageController controller = Get.put(WomenSaloonPageController());
        ...
        children: [
          Expanded(
            child: Obx(() {
              ...
              } else if (controller.allData[1].value!.subCategories.isEmpty) {
                return Center(child:  Text("No Data Available",style: GoogleFonts.poppins(color: Colors.black),));
              } else {
                return ListView.builder(
                  padding: EdgeInsets.symmetric(vertical: 10.h, horizontal: 15.w),
                  itemCount: controller.allData[1].value!.subCategories.length,
                  itemBuilder: (context, index) {
                    final data = controller.allData[1].value!.subCategories[index];
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Obx(() => TextField(
                                ...
                                enabled: controller.allData[1].value!.subCategories[index].enabled,
                            ...
                            Transform.scale(
                              ...
                              child: Obx(() => Switch(
                                value: controller.allData[1].value!.subCategories[index].enabled,
                                onChanged: (value) {
                                  controller.allData[1].value!.subCategories[index].enabled = value;
